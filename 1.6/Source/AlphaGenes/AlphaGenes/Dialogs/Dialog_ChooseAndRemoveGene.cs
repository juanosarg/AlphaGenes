...
namespace AlphaMemes
{
    ...
    public class Dialog_ChooseAndRemoveGene : Window
    {
        ...
        public Dialog_ChooseAndRemoveGene(Pawn pawn, Thing tool)
        {
            this.pawn = pawn;
            this.tool = tool;
            doCloseX = true;
        ...
        public override void DoWindowContents(Rect inRect)
        {
           ...
           if(pawn.genes != null) { 
                ...
                Widgets.Label(new Rect(0, 10, 300f, 30f), "AG_ChooseGeneToRemove".Translate());
                ...
                for (var i = 0; i < genes.Count; i++)
                {
                    ...
                    if (Widgets.ButtonInvisible(rectIcon))
                    {
                        ...
                        if (hediff == null)
                        {
                            ...
                            pawn.genes.RemoveGene(pawn.genes.GetGene(genes[i]));
                            tool.Destroy();
