...
namespace AlphaMemes
{
    ...
    public class Dialog_EndogeneToXenogene : Window
    {
        ...
        public Dialog_EndogeneToXenogene(Pawn pawn, Thing tool)
        {
            this.pawn = pawn;
            this.tool = tool;
            doCloseX = true;
        ...
        public override void DoWindowContents(Rect inRect)
        {
           ...
           if(pawn.genes != null) { 
                ...
                Widgets.Label(new Rect(0, 10, 300f, 30f), "AG_ChooseEndogeneToConvert".Translate());
                ...
                for (var i = 0; i < genes.Count; i++)
                {
                    ...
                    if (Widgets.ButtonInvisible(rectIcon))
                    {
                        ...
                        if (hediff == null)
                        {
                            ...
                            pawn.genes.Endogenes.Remove(pawn.genes.GetGene(genes[i]));
                            pawn.genes.AddGene(genes[i],true);
