...
namespace AlphaGenes
{
	...
	public class WorkGiver_HaulToGeneBankMixed : WorkGiver_Scanner
	{
		public override ThingRequest PotentialWorkThingRequest => ThingRequest.ForDef(InternalDefOf.AG_Mixedpack);
