...
{
	public class JobDriver_UseXenotypeNullifier : JobDriver
	{
		...
		protected override IEnumerable<Toil> MakeNewToils()
		{
			...
			use.initAction = delegate
			{
				...
				actor.CurJob.targetA.Thing.TryGetComp<CompTargetEffect_XenotypeNullifier>().DoEffectOn(actor, job.targetB.Thing);
