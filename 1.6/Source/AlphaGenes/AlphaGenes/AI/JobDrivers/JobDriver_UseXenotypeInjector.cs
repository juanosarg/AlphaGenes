...
{
    public class JobDriver_UseXenotypeInjector : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            use.initAction = delegate
            {
                ...
                actor.CurJob.targetA.Thing.TryGetComp<CompTargetEffect_XenotypeInjector>().DoEffectOn(actor, job.targetB.Thing);
