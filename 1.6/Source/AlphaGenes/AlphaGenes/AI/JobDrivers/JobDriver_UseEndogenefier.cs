...
{
	public class JobDriver_UseEndogenefier : JobDriver
	{
		...
		protected override IEnumerable<Toil> MakeNewToils()
		{
			...
			use.initAction = delegate
			{
				...
				actor.CurJob.targetA.Thing.TryGetComp<CompTargetEffect_Endogenefier>().DoEffectOn(actor, job.targetB.Thing);
