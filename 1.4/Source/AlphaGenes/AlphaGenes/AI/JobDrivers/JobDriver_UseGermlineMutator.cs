...
{
	public class JobDriver_UseGermlineMutator : JobDriver
	{
		...
		protected override IEnumerable<Toil> MakeNewToils()
		{
			...
			use.initAction = delegate
			{
				...
				actor.CurJob.targetA.Thing.TryGetComp<CompTargetEffect_GermlineMutator>().DoEffectOn(actor, job.targetB.Thing);
