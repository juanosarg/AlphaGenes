...
{
    public class JobDriver_UseGenepackDisruptor : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            use.initAction = delegate
            {
                ...
                actor.CurJob.targetA.Thing.TryGetComp<CompTargetEffect_GenepackDisruptor>().DoEffectOn(actor, job.targetB.Thing);
