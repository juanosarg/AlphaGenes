...
{
    public class JobDriver_UseArchoXenogenefier : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            use.initAction = delegate
            {
                ...
                actor.CurJob.targetA.Thing.TryGetComp<CompTargetEffect_ArchoXenogenefier>().DoEffectOn(actor, job.targetB.Thing);
