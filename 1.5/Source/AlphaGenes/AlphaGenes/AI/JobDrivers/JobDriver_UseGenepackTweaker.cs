...
{
    public class JobDriver_UseGenepackTweaker : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            use.initAction = delegate
            {
                ...
                actor.CurJob.targetA.Thing.TryGetComp<CompTargetEffect_GenepackTweaker>().DoEffectOn(actor, job.targetB.Thing);
