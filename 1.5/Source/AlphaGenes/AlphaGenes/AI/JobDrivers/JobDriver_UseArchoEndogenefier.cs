...
{
    public class JobDriver_UseArchoEndogenefier : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            use.initAction = delegate
            {
                ...
                actor.CurJob.targetA.Thing.TryGetComp<CompTargetEffect_ArchoEndogenefier>().DoEffectOn(actor, job.targetB.Thing);
