...
{
    public class JobDriver_UseArchoGeneRemover : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            use.initAction = delegate
            {
                ...
                actor.CurJob.targetA.Thing.TryGetComp<CompTargetEffect_ChooseAndRemoveGene>().DoEffectOn(actor, job.targetB.Thing);
