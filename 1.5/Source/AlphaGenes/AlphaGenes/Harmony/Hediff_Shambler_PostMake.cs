...
namespace AlphaGenes
{
    ...
    public static class AlphaGenes_Hediff_Shambler_PostMake_Patch
    {
        ...
        static void AddRandomGenes(Hediff_Shambler __instance)
        {
            ...
            {
                List<GeneDef> genes = DefDatabase<GeneDef>.AllDefsListForReading.Where(x => x.geneClass== typeof(Gene_Shambler)).ToList();
                ...
                if (numberToRemoveGasProducers.RandomInRange != 5)
                {
                    ...
                    genes.Remove(InternalDefOf.AG_Shambler_DeadlifeBelcher);
